...
protected:
    ...
    */
     ...
     * been computed.
     */
    struct Cmp : public std::function<bool(std::pair<internal_size_type, value_type>, std::pair<internal_size_type, value_type>)>
    {
        self_type& map_;
...
public:
    ...
    struct equal_to : public std::function<bool(key_type, key_type)>
    {
