...
template <typename BlockType,
          ...
          typename KeyExtractor>
struct run_cursor2_cmp : public std::function<bool(run_cursor2<BlockType, prefetcher_type>, run_cursor2<BlockType, prefetcher_type>)>
{
...
class key_comparison : public std::function<bool(RecordType, RecordType)>
{
    KeyExtractor ke;
